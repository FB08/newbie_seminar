...
export function toLectureWithProfessorResponseDTO(
  ...
  return {
    ...
    grade: count > 0 ? course.sumGrade / count : 0,              // TODO: 평균 계산
    load: count > 0 ? course.sumLoad / count : 0,               // TODO
    speech: count > 0 ? course.sumSpeech / count : 0,             // TODO
...
export function toTimetableLectureItemDTO(lecture: LectureWithCourseProfessorClasstime): TimetableLectureItemDTO {
  ...
  const count = lecture.reviewCount || 0;
  return {
    id: lecture.id,
    ...
    grade: count > 0 ? lecture.sumGrade / count : 0,              // TODO: 평균 계산
    load: count > 0 ? lecture.sumLoad / count : 0,               // TODO
    speech: count > 0 ? lecture.sumSpeech / count : 0,             // TODO
